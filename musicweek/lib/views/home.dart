...
const List<Choice> choices = const <Choice>[
  const Choice(title: 'Conversion taille de fichiers informatique', icon: Icons.broken_image),
  ...
  const Choice(title: 'Convertir décimal en chiffre romain', icon: Icons.calculate_outlined),
